...
CREATE PROCEDURE addNewCategory(IN name1 varchar(200))
BEGIN
...
CREATE PROCEDURE updateCategory(IN id int, IN name1 varchar(200))
BEGIN
...
CREATE PROCEDURE addNewProduct(IN categ int, IN prodname varchar(200), IN brand1 varchar(200), IN descr text, IN pict varchar(1000), IN price1 int, IN stock1 int)
BEGIN
...
CREATE PROCEDURE updateProduct(IN id int, IN categ int, IN prodname varchar(200), IN brand1 varchar(200), IN descr text, IN pict varchar(1000), IN price1 int, IN stock1 int)
BEGIN
    UPDATE product
